// -----------------------------------------------------------------------
// <copyright file="IdentityRedoPage.cs" company="Petabridge, LLC">
...
/// <summary>
/// Termina page hosting the single-step identity redo flow. Mirrors the single-step
/// section-editor host pattern: renders the identity step view, then a saved screen.
/// </summary>
public sealed class IdentityRedoPage : ReactivePage<IdentityRedoViewModel>
{
    ...
    public override ILayoutNode BuildLayout()
        => NetclawTuiChrome.BuildPageFrame("Netclaw Setup", BuildInnerLayout());
    ...
    private LayoutNode BuildHelpText()
    {
        ...
        {
            if (ViewModel.IsSaved.Value)
                return (ILayoutNode)new TextNode("").WithForeground(Color.Gray);
